...
public class SecondDatabaseConfig {
    ...
    public DataSource secondDataSource() {
        return DataSourceBuilder.create()
                ...
                .url("jdbc:mysql://app-mysql.c9euq66g4bec.ap-northeast-2.rds.amazonaws.com:3306/admin_db?useSSL=false&useUnicode=true&serverTimezone=Asia/Seoul&allowPublicKeyRetrieval=true")
                .username("admin")
                .password("password")
                .build();
    }
