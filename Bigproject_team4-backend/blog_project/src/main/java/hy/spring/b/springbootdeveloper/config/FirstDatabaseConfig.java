...
public class FirstDatabaseConfig {
    ...
    public DataSource firstDataSource() {
        return DataSourceBuilder.create()
                ...
                .url("jdbc:mysql://app-mysql.c9euq66g4bec.ap-northeast-2.rds.amazonaws.com:3306/users?useSSL=false&useUnicode=true&serverTimezone=Asia/Seoul&allowPublicKeyRetrieval=true")
                .username("admin")
                .password("hmhm408901*")
                .build();
    }
